...
(custom-theme-set-faces
 ...
 '(highlight ((t (:background "royalblue" :foreground "black" :weight bold))))
 '(region ((t (:background "grey16"))))
 ...
 '(company-tooltip-selection ((t (:background "steelblue" :foreground "black" :weight bold))))
